...
val demoExpressions = arrayOf(
    ...
    "4d6m2" to 5 to "keep 3 middle (even/even)",
    "4d6m3" to 6 to "keep 3 middle (even/odd)",
    "5d6m2" to 5 to "keep 3 middle (odd/even)",
    "5d6m3" to 9 to "keep 3 middle (odd/odd)",
    "4d6M2" to 5 to "case-insensitive",
    "2d20m" to 6 to "default keep 1 middle",
